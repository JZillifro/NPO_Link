...
export default class NPSection extends React.Component {
  ...
  refreshPage(page) {
     axios.get(`${BASE_API_URL}/v1.0/nonprofits/search/${page}?search_words=${this.state.query}&sort=${this.state.sort}&filters=${JSON.stringify(this.state.filters)}`).then(res => {
